...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // Second DenseLayer with 3 input features (from the previous layer) and 3
        // output neurons
     ...
     * This method iterates through each row of the 2D array and finds the index of
     * the maximum value in that row.
     * 
     ...
     * This method compares the predicted labels with the true labels and calculates
     * the accuracy.
     * 
