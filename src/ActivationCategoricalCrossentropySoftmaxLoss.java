...
public class ActivationCategoricalCrossentropySoftmaxLoss {
    ...
    /**
     * * Forward pass through the softmax activation and calculate the loss using
     ...
     * 
     * @param dvalues The gradient of the loss with respect to the output of the
     *                softmax activation (2D array).
