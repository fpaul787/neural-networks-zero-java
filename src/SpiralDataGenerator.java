...
/**
 * Generates a spiral dataset for classification tasks.
 */
public class SpiralDataGenerator {
    ...
    /**
     * Creates a linearly spaced array of doubles from start to end with num points.
     * Mimics numpy's linspace.
     * 
